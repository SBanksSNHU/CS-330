...
private:
	...
	// Configuring the various material settings used for objects in 3d
...
public:
	...
	void PrepareScene();
	void RenderScene();
	void MeshInitialization(glm::vec3 scale, glm::vec3 rotation, glm::vec3 position, glm::vec4 color);
