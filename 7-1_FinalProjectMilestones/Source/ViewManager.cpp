...
void ViewManager::Mouse_Scroll_Callback(GLFWwindow* window, double xWheelPos, double yWheelPos)
{
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	if (glfwGetKey(m_pWindow, GLFW_KEY_O) == GLFW_PRESS) {
		g_pCamera->ProcessKeyboard(ORTHOGRAPHIC, gDeltaTime);
	}
	if (glfwGetKey(m_pWindow, GLFW_KEY_P) == GLFW_PRESS) {
		g_pCamera->ProcessKeyboard(PERSPECTIVE, gDeltaTime);
	}
