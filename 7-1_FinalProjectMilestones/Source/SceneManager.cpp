...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture("Textures/abstract.jpg", "abstract");
	bReturn = CreateGLTexture("Textures/breadcrust.jpg", "breadcrust");
	bReturn = CreateGLTexture("Textures/cheese_top.jpg", "cheese_top");
	bReturn = CreateGLTexture("Textures/circular-brushed-gold-texture.jpg", "circular-brushed-gold-texture");
	bReturn = CreateGLTexture("Textures/knife_handle.jpg", "knife_handle");
	bReturn = CreateGLTexture("Textures/rusticwood.jpg", "rusticwood");
	...
	float alphaValue)
{
	...
	currentColor.r = redColorValue/WHITE;
	currentColor.g = greenColorValue/WHITE;
	currentColor.b = blueColorValue/WHITE;
...
void SceneManager::SetupSceneLights() {
	...
	m_pShaderManager->setVec3Value("lightSources[0].ambientColor", (215 / WHITE) * 0.45f, (240 / WHITE) * 0.45f, (110 / WHITE) * 0.45f);
	...
	m_pShaderManager->setVec3Value("lightSources[1].ambientColor", (236 / WHITE) * 0.45f, (27 / WHITE) * 0.45f, (29 / WHITE) * 0.45f);
	...
	m_pShaderManager->setVec3Value("lightSources[2].ambientColor", (51 / WHITE) * 0.45f, (96 / WHITE) * 0.45f, (174 / WHITE) * 0.45f);
...
void SceneManager::RenderScene()
{
	...
	/*********************************************************************/
	/* Methods to draw meshes above are deprecated and should not be used*/
	/*********************************************************************/
	...
	scale = glm::vec3(4.5f, 1.0f, 2.0f);
	rotation = glm::vec3(0.0f, 14.0f, 0.0f);
	position = glm::vec3(-1.49f, 1.0f, 1.0f);
	color = glm::vec4(237, 177, 151, 1);

	MeshInitialization(scale, rotation, position, color);
	SetShaderTexture("knife_handle");
	SetShaderMaterial("wood");
	m_basicMeshes->DrawBoxMesh();

	// Couch Arm Left
	scale = glm::vec3(0.5f, 2.0f, 2.0f);
	rotation = glm::vec3(0.0f, 14.0f, 0.0f);
	position = glm::vec3(-4.01f, 1.5f, 1.5f);
	color = glm::vec4(199, 149, 127, 1);
	...
	// Couch Back Left
	scale = glm::vec3(6.01f, 2.0f, 0.5f);
	rotation = glm::vec3(0.0f, 14.0f, 0.0f);
	position = glm::vec3(-1.01f, 1.5f, 0.5f);
	color = glm::vec4(199, 149, 127, 1);
	...
	// Couch Right
	scale = glm::vec3(4.5f, 1.01f, 2.0f);
	rotation = glm::vec3(0.0f, 108.0f, 0.0f);
	position = glm::vec3(1.61f, 1.0f, 1.0f);
	color = glm::vec4(191, 158, 145, 1);
	...
	scale = glm::vec3(0.5f, 2.0f, 2.0f);
	rotation = glm::vec3(0.0f, 108.0f, 0.0f);
	position = glm::vec3(2.21f, 1.0f, 3.0f);
	color = glm::vec4(140, 115, 106, 1);
	...
	scale = glm::vec3(5.0f, 2.0f, 0.5f);
	rotation = glm::vec3(0.0f, 108.0f, 0.0f);
	position = glm::vec3(2.71f, 1.0f, 1.0f);
	color = glm::vec4(139, 114, 105, 1);
	...
	//Top
	scale = glm::vec3(1.2f, 0.15f, 1.2f);
	rotation = glm::vec3(1.0f, 1.0f, 1.0f);
	position = glm::vec3(-0.5f, 0.6f, 5.0f);		
	...
	// +/- 0.75f
	// Leg #1
	scale = glm::vec3(0.10f, 0.70f, 0.10f);
	rotation = glm::vec3(1.0f, 1.0f, 1.0f);
	position = glm::vec3(-1.25f, 0.0f, 4.25f);
	color = glm::vec4(63, 29, 11, 1);
	...
	scale = glm::vec3(0.10f, 0.70f, 0.10f);
	rotation = glm::vec3(1.0f, 1.0f, 1.0f);
	position = glm::vec3(-1.25f, 0.0f, 5.75f);
	color = glm::vec4(63, 29, 11, 1);
	...
	scale = glm::vec3(0.10f, 0.70f, 0.10f);
	rotation = glm::vec3(1.0f, 1.0f, 1.0f);
	position = glm::vec3(0.25f, 0.0f, 4.25f);
	color = glm::vec4(63, 29, 11, 1);
	...
	scale = glm::vec3(0.10f, 0.70f, 0.10f);
	rotation = glm::vec3(1.0f, 1.0f, 1.0f);
	position = glm::vec3(0.25f, 0.0f, 5.75f);
	color = glm::vec4(63, 29, 11, 1);
...
void SceneManager::MeshInitialization(
	glm::vec3 scale,
	glm::vec3 rotation,
	glm::vec3 position,
	glm::vec4 color
	...
	// set the XYZ rotation for the mesh
	float XrotationDegrees = rotation[0];
	float YrotationDegrees = rotation[1];
	float ZrotationDegrees = rotation[2];
